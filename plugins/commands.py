...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('⚡ UᎮDΛTΞS ⚡', url='https://t.me/Movie_UpdatesIMV')
            ],
            [
                InlineKeyboardButton('⚡ Join ⚡', url=f"https://t.me/Movie_Linkzz"),
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ SUBSCᏒIBΞ ⚡', url='https://t.me/Movie_Linkzz'),
            InlineKeyboardButton('🤖 UᎮDΛTΞS 🤖', url='https://t.me/Movie_UpdatesIMV')
            ],[
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('Join', url='https://t.me/Tamil_Movies_IMV') ] ] ),
        protect_content=True if pre == 'filep' else False,
        )
